  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section id="grants" className="mb-12">
        <div className="mb-4">
          <h2 className="text-2xl font-bold text-gray-900">Grants</h2>
          ...
          {loans.map((loan) => (
            <AidCard key={loan.id} type="loan" title={loan.name}>
              ...
              <div className="mt-3 grid grid-cols-2 gap-2 text-sm sm:grid-cols-4">
                ...
                <div>
                  <span className="text-gray-500">Subsidized</span>
                  <p className="font-semibold text-gray-900">
              ...
              <div className="mt-2">
                ...
                <p className="text-sm text-gray-700">{loan.repaymentInfo}</p>
              </div>
            </AidCard>
          ))}
        </div>
...
function AidCard({
  ...
  const colorMap = {
    grant: "border-green-200",
    loan: "border-blue-200",
    scholarship: "border-purple-200",
  };
